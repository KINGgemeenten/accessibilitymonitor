...
/**
 * @file
 * Contains \Triquanta\AccessibilityMonitor\Console\Command\RescanWebsite.
 */
...
/**
 * Provides a command to re-scan a website.
 */
class RescanWebsite extends Command implements ContainerFactoryInterface {
