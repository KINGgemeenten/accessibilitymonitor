...
/**
 * @file
 * Contains \Triquanta\Tests\AccessibilityMonitor\Console\Command\ExcludeWebsiteTest.
 */

namespace Triquanta\Tests\AccessibilityMonitor\Console\Command;

use Symfony\Component\DependencyInjection\ContainerInterface;
use Triquanta\AccessibilityMonitor\Console\Command\ExcludeWebsite;
use Triquanta\AccessibilityMonitor\Website;

/**
 * @coversDefaultClass \Triquanta\AccessibilityMonitor\Console\Command\ExcludeWebsite
 */
class ExcludeWebsiteTest extends \PHPUnit_Framework_TestCase {

  /**
   * The command under test.
   *
   * @var \Triquanta\AccessibilityMonitor\Console\Command\ExcludeWebsite
   */
  protected $command;
  ...
  public function setUp() {
    ...
    $this->command = new ExcludeWebsite($this->actions, $this->storage);
  }
  ...
  public function testCreate() {
    ...
    $command = ExcludeWebsite::create($container);
    $this->assertInstanceOf('\Triquanta\AccessibilityMonitor\Console\Command\ExcludeWebsite', $command);
  }
